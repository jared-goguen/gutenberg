...
export type ComponentType = "hero" | "features" | "content" | "cta" | "navigation" | "footer" | "table";
...
export declare function isPageSchema(spec: GutenbergSpec): spec is PageSchema;
export declare function isTemplateSchema(spec: GutenbergSpec): spec is TemplateSchema;
