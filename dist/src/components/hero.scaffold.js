 ...
 */
export function scaffoldHero(data, mode = 'view', section) {
                ...
                ...(data.ctas.length > 0 || data.secondaryCtas.length > 0
                    ? [
                        createNode("div", {
                            layout: { align: "left" },
                            children: [
                                ...data.ctas.map((cta) => createNode("a", {
                                    role: "btn-primary",
                                    attrs: { href: cta.href },
                                    children: [cta.text],
                                })),
                                ...data.secondaryCtas.map((cta) => createNode("a", {
                                    role: "btn-secondary",
                                    attrs: { href: cta.href },
                                    children: [cta.text],
                                })),
...
//# sourceMappingURL=hero.scaffold.js.map